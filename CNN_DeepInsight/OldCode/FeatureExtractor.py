...
parser.add_argument("--model", dest='model', help = 'DL model to extract features')
...
def lm_reg(modell, image_features_data):
    ...
    Pred_CorrDF.to_csv(f"../../temp/DLs/{modell}.csv", index = False)


image_features_data = image_extractor(model_name = args.model)
lm_reg(modell = args.model,
