...
FA_density_plot_generator = function(df,
                                     ...
                                     ylim){
  df = df
  FmetL_con = readRDS("../Met/FmetL_con.RDS")
  FmetL_trt = readRDS("../Met/FmetL_trt.RDS")
...
DLs_RR_reader <- function(model, alpha){
  ...
  model_alphaL = list()
  for (i in 1:100){
    path = paste0("../ARC_outputs/Met_same_genotypes_per_treatment/DLs_RR/", model, "_cv", i,"_alpha", alpha, ".csv")
    # print(path)
